...
import "../../../styles/layout/_new-product.scss";

// Mock Data
const NEW_PRODUCTS = [
  {
    id: 1,
    title: "Laptop HP OMEN 17t Gaming Intel Core i7",
    price: 530.6,
    oldPrice: 650.56,
    rating: 4.5,
    tag: "NEW",
    img: "https://via.placeholder.com/200?text=Laptop+HP",
  },
  {
    id: 2,
    ...
    oldPrice: 98.74,
    rating: 4.5,
    img: "https://via.placeholder.com/200?text=CCTV",
  },
  {
    id: 3,
    title: "Sony450 unic styles headphone",
    price: 260.63,
    oldPrice: 350.45,
    rating: 4.5,
  ...
  {
    id: 4,
    title: "MacBook Pro 13-inch MacBook Air Laptop",
    price: 895.89,
    rating: 4.5,
    tag: "SALE",
    img: "https://via.placeholder.com/200?text=Macbook",
  },
  {
    id: 5,
    ...
    price: 1830.89,
    rating: 4.5,
    img: "https://via.placeholder.com/200?text=Monitor",
  },
  {
    id: 6,
    ...
    rating: 5.0,
    tag: "NEW",
    img: "https://via.placeholder.com/200?text=Mouse",
  },
  {
    id: 7,
    ...
    price: 120.0,
    rating: 4.8,
    img: "https://via.placeholder.com/200?text=Keyboard",
  },
  {
    id: 8,
    ...
    rating: 4.7,
    tag: "SALE",
    img: "https://via.placeholder.com/200?text=SSD",
  },
];
...
const NewProduct = () => {
  ...
  const itemsToShow = 5;
  const maxIndex = Math.max(0, NEW_PRODUCTS.length - itemsToShow);
